...
// console.log(ans.match(reg));  // метод match возвращает массив с полученными данными
// console.log(ans.match(reg2));  // с глобальным флагом будут выглядит по другому. 
...
//--------------------------------------
// если мы хотим искать определенные классы. Символы, цифры, строки, булиновые значения, то используем КЛАССЫ
